...
> = {
  ...
  "Requin Renard": {
    desc: "Utilise sa queue immense comme un fouet pour assommer ses proies.",
    taille: "3 à 5 mètres",
    danger: "🟢 Inoffensif",
    depth: "0 - 500m",
  ...
  "Requin Nourrice": {
    desc: "Passe ses journées à dormir sur le sable dans les grottes.",
    taille: "2 à 3 mètres",
    danger: "🟢 Inoffensif",
    depth: "1 - 75m",
  ...
  "Raie Pastenague": {
    desc: "Possède un dard venimeux à la base de la queue.",
    taille: "1 à 2 mètres",
  ...
  Narval: {
    desc: "La 'licorne des mers' avec sa dent unique en spirale.",
    taille: "4 à 5 mètres",
    danger: "🟢 Inoffensif",
    depth: "0 - 1500m",
  ...
  Cachalot: {
    desc: "Le plus grand prédateur à dents, plonge à des profondeurs extrêmes.",
  ...
  Marsouin: {
    desc: "Plus petit et plus discret que le dauphin.",
  ...
  "Tortue Luth": {
    desc: "La plus grande des tortues, sa carapace ressemble à du cuir.",
  ...
  "Tortue Caouanne": {
    desc: "Possède une tête massive et des mâchoires puissantes.",
  ...
  "Thon Rouge": {
    desc: "Le sprinter des océans, peut nager jusqu'à 70 km/h.",
    taille: "2 à 3 mètres",
    danger: "🟢 Inoffensif",
    depth: "0 - 1000m",
  ...
  Espadon: {
    desc: "Armé d'un long rostre pour fendre l'eau et chasser.",
  ...
  Mérou: {
    desc: "Poisson territorial et curieux qui peut vivre 50 ans.",
    taille: "1 à 2.5 mètres",
    danger: "🟢 Inoffensif",
    depth: "5 - 150m",
  ...
  "Poisson Perroquet": {
    desc: "Grignote le corail et crée le sable blanc des plages.",
    taille: "30 à 70 cm",
    danger: "🟢 Inoffensif",
    depth: "1 - 30m",
  ...
  "Môle (Poisson Lune)": {
    desc: "Ressemble à une énorme galette flottante, adore bronzer en surface.",
    taille: "2 à 3 mètres",
    danger: "🟢 Inoffensif",
    depth: "0 - 600m",
  ...
  "Poisson-Pierre": {
    desc: "Le poisson le plus venimeux au monde. Parfaitement camouflé.",
    taille: "30 à 40 cm",
  ...
  "Murène Ruban": {
    desc: "Change de couleur et de sexe au cours de sa vie.",
    taille: "1 mètre",
    danger: "🟢 Inoffensif",
    depth: "1 - 20m",
  ...
  Seiche: {
    desc: "Maître du camouflage capable de changer de texture et de couleur.",
    taille: "20 à 50 cm",
    danger: "🟢 Inoffensif",
    depth: "0 - 150m",
  ...
  Calamar: {
    desc: "Prédateur rapide doté de dix bras.",
    taille: "30 à 60 cm",
    danger: "🟢 Inoffensif",
    depth: "0 - 500m",
  ...
  "Calamar Géant": {
    desc: "Vivant dans les abysses, il a alimenté les légendes du Kraken.",
  ...
  Nautile: {
    desc: "Fossile vivant doté d'une magnifique coquille spiralée.",
    taille: "15 à 25 cm",
    danger: "🟢 Inoffensif",
    depth: "100 - 600m",
  ...
  "Méduse Boîte": {
    desc: "Transparente et extrêmement redoutable.",
    taille: "20 à 30 cm",
    danger: "🔴 Mortel",
    depth: "0 - 10m",
  ...
  "Poisson Mandarin": {
    desc: "L'un des poissons les plus colorés au monde, célèbre pour sa danse nuptiale.",
    taille: "6 à 10 cm",
    danger: "🟢 Inoffensif",
    depth: "1 - 20m",
  ...
  "Pieuvre à anneaux bleus": {
    desc: "Petite mais extrêmement venimeuse. Ses anneaux brillent en cas de menace.",
    taille: "10 à 20 cm",
    danger: "🔴 Mortel",
    depth: "0 - 20m",
  ...
  "Bénitier Géant": {
    desc: "Le plus grand mollusque bivalve. Peut vivre plus de 100 ans.",
  ...
  Nudibranche: {
    desc: "Limace de mer aux couleurs flamboyantes servant d'avertissement.",
    taille: "1 à 15 cm",
    danger: "🟢 Inoffensif",
    depth: "0 - 50m",
  ...
  "Poisson Chirurgien Bleu": {
    desc: "Rendu célèbre par 'Dory', il possède une épine tranchante à la base de la queue.",
    taille: "20 à 30 cm",
  ...
  "Baliste Titan": {
    desc: "Très territorial, il peut charger les plongeurs pour protéger son nid.",
    taille: "40 à 75 cm",
  ...
  "Poisson Grenouille": {
    desc: "Maître du camouflage et de la patience, il 'marche' sur ses nageoires.",
    taille: "5 à 30 cm",
    danger: "🟢 Inoffensif",
    depth: "1 - 100m",
  ...
  "Dragon de Mer Feuillu": {
    desc: "Ressemble à des algues dérivantes. Unique aux eaux australiennes. Hippocampe feuille",
    taille: "20 à 35 cm",
    danger: "🟢 Inoffensif",
    depth: "4 - 30m",
  ...
  "Raie pastenague à taches bleues": {
    desc: "Petite raie colorée vivant souvent sous les surplombs rocheux.",
    taille: "30 à 70 cm",
  ...
  "Hippocampe Pygmée": {
    desc: "Si petit et bien camouflé qu'il est presque impossible à voir sur les gorgones.",
    taille: "1.5 à 2 cm",
    danger: "🟢 Inoffensif",
    depth: "10 - 40m",
  ...
  "Poisson Coffre Jaune": {
    desc: "Corps cubique et rigide, il devient plus sombre en grandissant.",
    taille: "15 à 45 cm",
    danger: "🟢 Inoffensif",
    depth: "1 - 280m",
  ...
  "Poisson Trompette": {
    desc: "S'aligne verticalement pour se cacher parmi les coraux ou les plongeurs.",
    taille: "40 à 80 cm",
    danger: "🟢 Inoffensif",
    depth: "2 - 100m",
  ...
  "Anguille Jardinière": {
    desc: "Vit en colonies, dressée hors de son trou dans le sable comme une plante.",
    taille: "30 à 40 cm",
    danger: "🟢 Inoffensif",
    depth: "5 - 45m",
  ...
  "Labre Nettoyeur": {
    desc: "Établit des 'stations de lavage' pour manger les parasites des gros poissons.",
    taille: "10 à 14 cm",
    danger: "🟢 Inoffensif",
    depth: "1 - 30m",
  ...
  Rémora: {
    desc: "Possède une ventouse sur la tête pour se fixer aux requins ou tortues.",
    taille: "30 à 90 cm",
    danger: "🟢 Inoffensif",
    depth: "0 - 100m",
  ...
  "Galère Portugaise": {
    desc: "Ce n'est pas une méduse mais une colonie d'organismes. Très urticante.",
  ...
  "Poisson Ange Duc": {
    desc: "Rayures verticales bleues, blanches et oranges. Très élégant.",
    taille: "20 à 25 cm",
    danger: "🟢 Inoffensif",
    depth: "2 - 50m",
  ...
  "Poisson Écureuil": {
    desc: "Poisson nocturne doté de grands yeux pour voir dans l'obscurité.",
    taille: "15 à 30 cm",
    danger: "🟢 Inoffensif",
    depth: "1 - 100m",
  ...
  "Girelle Paon": {
    desc: "Petit poisson très vif aux couleurs arc-en-ciel, commun en Méditerranée.",
    taille: "15 à 25 cm",
    danger: "🟢 Inoffensif",
    depth: "1 - 30m",
  ...
  Béluga: {
    desc: "Surnommé le 'canari des mers' à cause de ses sifflements aigus. Il est entièrement blanc.",
    taille: "3 à 5 mètres",
    danger: "🟢 Inoffensif",
    depth: "0 - 800m",
  ...
  "Requin du Groenland": {
    desc: "Le vertébré à la longévité record : il peut vivre plus de 400 ans dans les eaux glacées.",
    taille: "4 à 7 mètres",
    danger: "🟠 Respecter une distance",
    depth: "0 - 2200m",
  ...
  "Baudroie Abyssale": {
    desc: "Possède un leurre lumineux sur la tête pour attirer ses proies dans le noir total.",
    taille: "20 à 60 cm",
  ...
  "Requin Lutin": {
    desc: "Un requin préhistorique rare avec un museau allongé et une mâchoire extensible.",
    taille: "3 à 4 mètres",
    danger: "🟢 Inoffensif",
    depth: "100 - 1300m",
  ...
  "Macropinna Microstoma": {
    desc: "Poisson fascinant avec un dôme transparent sur la tête laissant voir ses yeux verts.",
    taille: "15 cm",
    danger: "🟢 Inoffensif",
    depth: "500 - 1000m",
  ...
  "Marlin Bleu": {
    desc: "L'un des poissons les plus rapides et les plus puissants au monde.",
    taille: "3 à 5 mètres",
    danger: "🟠 Danger si acculé",
    depth: "0 - 200m",
  ...
  "Requin Mako": {
    desc: "Le guépard des mers, capable de pointes de vitesse à plus de 70 km/h.",
  ...
  Tarpon: {
    desc: "Énorme poisson argenté capable de sauter hors de l'eau pour respirer de l'air.",
  ...
  "Baliste Picasso": {
    desc: "Reconnaissable à ses motifs géométriques rappelant une peinture moderne.",
    taille: "25 à 30 cm",
    danger: "🟢 Inoffensif",
    depth: "1 - 10m",
  ...
  "Poisson-Ballon": {
    desc: "Se gonfle d'eau pour effrayer ses prédateurs. Contient un poison mortel.",
    taille: "30 à 50 cm",
  ...
  "Poisson-Vache": {
    desc: "Petit poisson coffre avec deux cornes sur la tête.",
    taille: "10 à 40 cm",
    danger: "🟢 Inoffensif",
    depth: "1 - 50m",
  ...
  "Poisson-Chauve-souris": {
    desc: "Corps très plat et lèvres rouges vives (pour certaines espèces des Galapagos).",
    taille: "20 à 40 cm",
    danger: "🟢 Inoffensif",
    depth: "3 - 70m",
  ...
  "Dauphin à long bec": {
    desc: "Célèbre pour ses sauts acrobatiques où il tournoie sur lui-même.",
    taille: "1.8 à 2.2 mètres",
    danger: "🟢 Inoffensif",
    depth: "0 - 50m",
  ...
  "Raie Guitare": {
    desc: "Une forme intermédiaire entre le requin et la raie.",
    taille: "1.5 à 2.5 mètres",
    danger: "🟢 Inoffensif",
    depth: "1 - 100m",
  ...
  "Squille (Crevette Mante)": {
    desc: "Possède les yeux les plus complexes du règne animal et une frappe ultra-puissante.",
    taille: "10 à 30 cm",
  ...
  "Pieuvre Géante du Pacifique": {
    desc: "La plus grande et la plus intelligente des pieuvres.",
    taille: "3 à 5 mètres",
    danger: "🟢 Inoffensif",
    depth: "0 - 1500m",
  ...
  "Étoile de Mer Pourpre": {
    desc: "Étoile de mer commune aux couleurs éclatantes, très résistante.",
    taille: "15 à 25 cm",
    danger: "🟢 Inoffensif",
    depth: "0 - 200m",
  ...
  "Corail Cerveau": {
    desc: "Corail dur dont les motifs ressemblent aux circonvolutions d'un cerveau.",
  ...
  "Éponge Baril": {
    desc: "Surnommée la 'séquoia de l'océan' pour sa taille et sa longévité millénaire.",
    taille: "1 à 2 mètres",
    danger: "🟢 Inoffensif",
    depth: "10 - 50m",
  ...
  "Poisson-Papillon": {
    desc: "Petit poisson de récif élégant, souvent en couple inséparable.",
    taille: "15 à 20 cm",
    danger: "🟢 Inoffensif",
    depth: "1 - 40m",
  ...
  // --- REPTILES MARINS ---
  "Tricot Rayé": {
    desc: "Un serpent marin extrêmement venimeux mais très docile, souvent vu sur les récifs du Pacifique.",
    taille: "1 à 1.5 mètre",
    danger: "🔴 Très Venimeux",
    depth: "0 - 30m",
    group: "Reptiles",
  ...
  "Anémone Magnifique": {
    desc: "L'habitat privilégié des poissons-clowns. Ses tentacules abritent des cellules urticantes.",
    taille: "30 à 50 cm",
    danger: "🟠 Urticant",
    depth: "1 - 20m",
    group: "Cnidaires",
  ...
  "Méduse Aurélie": {
    desc: "Méduse commune en forme de disque translucide, reconnaissable à ses quatre gonades en forme de fer à cheval.",
    taille: "25 à 40 cm",
  ...
  "Corail de Feu": {
    desc: "Ressemble à un corail mais appartient aux hydrozoaires. Provoque de fortes brûlures au contact.",
    taille: "Variable",
  ...
  "Oursin Diadème": {
    desc: "Possède des piquants noirs extrêmement longs et fins. Très commun dans les récifs tropicaux.",
    taille: "20 à 30 cm",
  ...
  "Étoile de Mer Couronne d'Épines": {
    desc: "Se nourrit de corail et peut ravager des récifs entiers. Elle est couverte de pointes venimeuses.",
    taille: "25 à 35 cm",
  ...
  "Holothurie Ananas": {
    desc: "Un concombre de mer massif dont les papilles ressemblent aux écailles d'un ananas.",
    taille: "40 à 70 cm",
    danger: "🟢 Inoffensif",
    depth: "2 - 30m",
    group: "Échinodermes",
  ...
  "Crevette Nettoyeuse": {
    desc: "Établit des stations de nettoyage où elle déparasite les poissons et même les plongeurs.",
    taille: "5 à 6 cm",
    danger: "🟢 Inoffensif",
    depth: "2 - 40m",
    group: "Arthropodes",
  ...
  "Cône Géographe": {
    desc: "L'un des coquillages les plus dangereux au monde. Son dard venimeux peut être mortel.",
    taille: "10 à 15 cm",
    danger: "🔴 Mortel",
    depth: "1 - 20m",
    group: "Mollusques",
  ...
  "Nudibranche Chromodoris": {
    desc: "Limace de mer aux motifs pyjamas bleus et jaunes. Une star de la macrophotographie.",
    taille: "3 à 5 cm",
    danger: "🟢 Inoffensif",
    depth: "5 - 30m",
    group: "Mollusques",
  ...
  "Porcelaine (Cypraea)": {
    desc: "Coquillage au test très brillant et lisse, autrefois utilisé comme monnaie.",
    taille: "5 à 10 cm",
    danger: "🟢 Inoffensif",
    depth: "0 - 20m",
    group: "Mollusques",
  ...
  "Poisson-Faucon à long nez": {
    desc: "Petit poisson très vif souvent posté immobile sur les branches de gorgones.",
    taille: "10 à 13 cm",
    danger: "🟢 Inoffensif",
    depth: "10 - 50m",
    group: "Poissons",
  ...
  "Poisson-Lime": {
    desc: "Reconnaissable à sa forme plate et sa peau rugueuse comme une lime.",
    taille: "20 à 40 cm",
    danger: "🟢 Inoffensif",
    depth: "1 - 30m",
    group: "Poissons",
  ...
  "Léopard de Mer": {
    desc: "Le super-prédateur de l'Antarctique. Puissant et doté d'une mâchoire impressionnante.",
  ...
  "Manchot Papou": {
    desc: "Le nageur le plus rapide de tous les manchots, capable d'atteindre 35 km/h sous l'eau.",
    taille: "70 à 80 cm",
    danger: "🟢 Inoffensif",
    depth: "0 - 150m",
    group: "Mammifères Marins", // Classification simplifiée pour l'app, ou "Oiseaux"
    family: "Oiseau marin",
  ...
  "Grand Cormoran": {
    desc: "Oiseau marin capable de plonger à des profondeurs surprenantes pour chasser ses poissons.",
    taille: "80 à 100 cm",
    danger: "🟢 Inoffensif",
    depth: "0 - 10m",
    group: "Poissons", // À classer dans "Oiseaux Marins" si tu crées le groupe
    family: "Oiseau marin",
  ...
  "Triton Géant": {
    desc: "L'un des rares prédateurs naturels de l'étoile couronne d'épines. Coquillage protégé.",
    taille: "30 à 50 cm",
    danger: "🟢 Inoffensif",
    depth: "1 - 30m",
    group: "Mollusques",
  ...
  "Oursin Crayon": {
    desc: "Possède des piquants très larges et émoussés, autrefois utilisés pour écrire sur l'ardoise.",
    taille: "10 à 15 cm",
    danger: "🟢 Inoffensif",
    depth: "1 - 25m",
    group: "Échinodermes",
